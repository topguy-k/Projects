...
REM
REM Generated by Vivado on Fri Mar 20 00:04:41 +0530 2026
...
echo "xvlog --incr --relax -prj ALU_main_vlog.prj"
call xvlog  --incr --relax -prj ALU_main_vlog.prj -log xvlog.log
