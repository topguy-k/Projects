...
REM
REM Generated by Vivado on Thu Mar 19 23:24:20 +0530 2026
...
echo "xvlog --incr --relax -prj mainlogic_tb_vlog.prj"
call xvlog  --incr --relax -prj mainlogic_tb_vlog.prj -log xvlog.log
